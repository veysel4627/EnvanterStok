        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="giren_urunler.php">Giren Ürünler</a>
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="#!">Çıkan Ürünler</a>
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="#!">Tedarikçiler</a>
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="#!">Çalışanlar</a>
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="stok.php">Stok İşlemleri</a>
